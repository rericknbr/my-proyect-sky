...
export default function HistoryScreen() {
  ...
  function handleClearAll() {
    Alert.alert(
      "Borrar historial",
      "¿Seguro que quieres eliminar todos los viajes guardados?",
      [
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {history.length > 0 && (
          <TouchableOpacity
            ...
            style={[styles.clearBtn, { borderColor: colors.destructive + "44" }]}
          >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TripCard trip={item} onDelete={deleteHistoryItem} />
        )}
