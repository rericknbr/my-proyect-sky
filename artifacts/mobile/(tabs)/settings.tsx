...
export default function SettingsScreen() {
  ...
  async function handleSave() {
    ...
    if (yellow >= green) {
      Alert.alert(
        "Valores inválidos",
        "El límite EXCELENTE debe ser mayor que el límite ACEPTABLE."
      );
      return;
    }
    if (Platform.OS !== "web") {
      ...
      >
        ...
        <View style={styles.thresholds}>
          <View style={styles.threshold}>
            <View
              style={[styles.thresholdIndicator, { backgroundColor: colors.semGreen }]}
            />
          ...
          <View style={styles.threshold}>
            <View
              style={[styles.thresholdIndicator, { backgroundColor: colors.semYellow }]}
            />
            <View style={styles.thresholdContent}>
              <Text style={[styles.thresholdLabel, { color: colors.foreground }]}>
                ACEPTABLE — ≥
          ...
          <View style={styles.threshold}>
            <View
              style={[styles.thresholdIndicator, { backgroundColor: colors.semRed }]}
            />
            <View style={styles.thresholdContent}>
              <Text style={[styles.thresholdLabel, { color: colors.foreground }]}>
