...
export function FloatingCalculator() {
  ...
  function calcOffX(fabX: number) {
    return fabX + FAB_SIZE / 2 >= SCREEN_W / 2
      ? -(PANEL_W + 8)
      : FAB_SIZE + 8;
  }
  function calcOffY(fabY: number) {
  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderRelease: (_, g) => {
        ...
        const snapX =
          rawX + FAB_SIZE / 2 < SCREEN_W / 2 ? 16 : SCREEN_W - FAB_SIZE - 16;
          ...
          >
            ...
            <View style={styles.row}>
              ...
              <TouchableOpacity
                ...
                style={[styles.unitBtn, { backgroundColor: colors.primary }]}
              >
            ...
            <TextInput
              ...
              placeholder="🛣 Distancia viaje km"
              placeholderTextColor={colors.mutedForeground}
              keyboardType="decimal-pad"
              value={tripDist}
                ...
                <View style={styles.resultBottom}>
                  ...
                  >
                    <Feather
                      ...
                      size={12}
                      color={saved ? colors.semGreen : colors.primary}
                    />
                  </TouchableOpacity>
                </View>
              )}
